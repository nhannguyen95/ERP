...
public class Node {
    ...
    private Map<Integer, Integer> globToLocal;  /* Used to convert the global graph id of the node to the children id of a parent.
                                                 ...
                                                 */ 
    private Node parent;
    private FuzzyMatrix pairwise;    // Pairwise (with respect to the goal) matrix of its children (criterias), only in parent nodes.
    private FuzzyMatrix pairwiseAlt; // Pairwise (with respect to the alternatives) matrix, only in leaf nodes.
    ...
    public void setPairwise(FuzzyMatrix pairwise) {
        this.pairwise = pairwise;
    }
    
    public FuzzyMatrix getPairwise() {
    ...
    public void setPairwiseAlt(FuzzyMatrix pairwise) {
    ...
    public FuzzyMatrix getPairwiseAlt() {
